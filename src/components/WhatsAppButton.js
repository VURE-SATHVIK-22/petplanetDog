...
const WhatsAppButton = () => {
  const phoneNumber = "919876543210"; // Placeholder number, can be updated by user
  const message = "Hello Dr. Suresh Babu, I would like to inquire about your veterinary services.";
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:bg-[#128C7E] transition-all duration-300 hover:scale-110 flex items-center justify-center">
        <svg 
          viewBox="0 0 24 24" 
